...
================
*/
static void G_RankFireWeapon(int self, int weapon) {
...
================
*/
static void G_RankDamage(int self, int attacker, int damage, int means_of_death) {
...
================
*/
static void G_RankPlayerDie(int self, int attacker, int means_of_death) {
	int p1;
	int p2;
...
================
*/
static void G_RankWeaponTime(int self, int weapon) {
	gclient_t *client;
	int time;
...
================
*/
static void G_RankPickupWeapon(int self, int weapon) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankPickupAmmo(int self, int weapon, int quantity) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankPickupHealth(int self, int quantity) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankPickupArmor(int self, int quantity) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankPickupPowerup(int self, int powerup) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankPickupHoldable(int self, int holdable) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankUseHoldable(int self, int holdable) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankReward(int self, int award) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankCapture(int self) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankUserTeamName(int self, char *team_name) {
	if (level.warmupTime != 0) {
		// no reports during warmup period
		return;
	}
...
================
*/
static void G_RankClientDisconnect(int self) {
	gclient_t *client;
	int time;
	int match_rating;
...
================
*/
static void G_RankGameOver(void) {
	int i;
