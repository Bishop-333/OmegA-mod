...
G_CVAR( g_chaos, "g_chaos", "0", CVAR_ARCHIVE | CVAR_SYSTEMINFO, 0, qtrue, qfalse )
...
G_CVAR( g_itemDrop, "g_itemDrop", "3", CVAR_ARCHIVE, 0, qtrue, qfalse )
G_CVAR( g_easierPickup, "g_easierPickup", "1", CVAR_ARCHIVE | CVAR_SYSTEMINFO, 0, qtrue, qfalse )
G_CVAR( g_fastSwitch, "g_fastSwitch", "1", CVAR_ARCHIVE | CVAR_SYSTEMINFO, 0, qtrue, qfalse )
...
G_CVAR( g_railgunFireRate, "g_railgunFireRate", "1500", CVAR_SYSTEMINFO, 0, qtrue, qfalse )
...
G_CVAR( g_regularFootsteps, "g_regularFootsteps", "1", CVAR_ARCHIVE | CVAR_SYSTEMINFO, 0, qtrue, qfalse )
G_CVAR( g_rocketFireRate, "g_rocketFireRate", "800", CVAR_SYSTEMINFO, 0, qtrue, qfalse )
G_CVAR( g_rocketSpeed, "g_rocketSpeed", "1000", 0, 0, qtrue, qfalse )
G_CVAR( g_slickGround, "g_slickGround", "0", CVAR_ARCHIVE | CVAR_SYSTEMINFO, 0, qtrue, qfalse )
