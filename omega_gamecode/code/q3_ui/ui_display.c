...
static void UI_DisplayOptionsMenu_Init( void ) {
	...
	displayOptionsInfo.banner.string = UI_Translate( "SYSTEM SETUP" );
	...
	displayOptionsInfo.graphics.string = UI_Translate( "GRAPHICS" );
	...
	displayOptionsInfo.display.string = UI_Translate( "DISPLAY" );
	...
	displayOptionsInfo.sound.string = UI_Translate( "SOUND" );
	...
	displayOptionsInfo.network.string = UI_Translate( "NETWORK" );
