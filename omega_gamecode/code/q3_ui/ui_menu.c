...
void UI_MainMenu( void ) {
	...
	trap_Cvar_SetValue( "handicap", 100 ); //Reset handicap during server change, it must be set per game
	...
	s_main.singleplayer.generic.ownerdraw = UI_DrawMenuString;
	...
	s_main.multiplayer.generic.ownerdraw = UI_DrawMenuString;
	...
	s_main.setup.generic.ownerdraw = UI_DrawMenuString;
	...
	s_main.demos.generic.ownerdraw = UI_DrawMenuString;
	...
	s_main.challenges.generic.ownerdraw = UI_DrawMenuString;
	...
	s_main.openArena.generic.ownerdraw = UI_DrawMenuString;
	...
	s_main.mods.generic.ownerdraw = UI_DrawMenuString;
	...
	s_main.exit.generic.ownerdraw = UI_DrawMenuString;
