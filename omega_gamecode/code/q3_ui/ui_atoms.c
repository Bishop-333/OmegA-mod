...
void UI_DrawString( int x, int y, const char *str, int style, vec4_t color ) {
	...
	} else if ( style & UI_MEDIUMFONT ) {
		charw = MEDIUMCHAR_WIDTH;
		charh = MEDIUMCHAR_HEIGHT;
...
static const uiTranslation_t uiTranslations[] = {
	{ "ADD BOTS", "AJOUTER DES ROBOTS" },
	{ "CALL VOTE", "VOTER" },
	{ "CHANGE TEAM", "CHANGER D'EQUIPE" },
	{ "CONTROLS", "CONTROLES" },
	{ "DEFAULTS", "DEFAUTS" },
	{ "DISPLAY", "AFFICHAGE" },
	{ "EXIT", "QUITTER" },
	...
	{ "NO", "NON" },
	{ "PLAYER", "JOUEUR" },
	{ "PLAYER MODEL", "MODELE DU JOUEUR" },
	{ "PLAYER SETTINGS", "PARAMETRES DU JOUEUR" },
	{ "REMOVE BOTS", "ENLEVER DES ROBOTS" },
	{ "RESTART ARENA", "REDEMARER L'ARENE" },
