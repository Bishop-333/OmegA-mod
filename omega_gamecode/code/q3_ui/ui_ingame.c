...
static void InGame_MenuInit( void ) {
	...
	s_ingame.resume.string = UI_Translate( "RESUME" );
	...
	s_ingame.team.string = UI_Translate( "CHANGE TEAM" );
	...
	s_ingame.addbots.string = UI_Translate( "ADD BOTS" );
	...
	s_ingame.removebots.string = UI_Translate( "REMOVE BOTS" );
	...
	s_ingame.teamorders.string = UI_Translate( "TEAM ORDERS" );
	...
	s_ingame.vote.string = UI_Translate( "CALL VOTE" );
	...
	s_ingame.setup.string = UI_Translate( "SETUP" );
	...
	s_ingame.server.string = UI_Translate( "SERVER INFO" );
	...
	s_ingame.challenges.string = UI_Translate( "STATISTICS" );
	...
	s_ingame.restart.string = UI_Translate( "RESTART ARENA" );
	...
	s_ingame.leave.string = UI_Translate( "LEAVE ARENA" );
	...
	s_ingame.quit.string = UI_Translate( "EXIT GAME" );
