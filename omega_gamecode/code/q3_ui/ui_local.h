...
extern vmCvar_t ui_saved_fxaa;
extern vmCvar_t ui_saved_maxfps;
extern vmCvar_t ui_saved_msaa;
...
void UI_PlayerInfo_SetInfo( playerInfo_t *pi, int legsAnim, int torsoAnim, vec3_t viewAngles, vec3_t moveAngles, weapon_t weaponNum, qboolean chat, int smiley );
...
extern void UI_DrawBackgroundPic( qhandle_t hShader );
...
extern void UI_DrawMenuString( void *self );
