...
CG_CVAR( cg_fov, "cg_fov", "110", CVAR_ARCHIVE )
...
CG_CVAR( cg_drawTimer, "cg_drawTimer", "4", CVAR_ARCHIVE )
...
CG_CVAR( cg_drawAttacker, "cg_drawAttacker", "0", CVAR_ARCHIVE )
CG_CVAR( cg_drawSpeed, "cg_drawSpeed", "0", CVAR_ARCHIVE )
CG_CVAR( cg_drawCrosshair, "cg_drawCrosshair", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawCrosshairNames, "cg_drawCrosshairNames", "0", CVAR_ARCHIVE )
...
CG_CVAR( cg_thirdPersonOffset, "cg_thirdPersonOffset", "25", CVAR_ARCHIVE )
...
CG_CVAR( cg_drawFriend, "cg_drawFriend", "2", CVAR_ARCHIVE )
...
CG_CVAR( cg_blood, "com_blood", "2", CVAR_ARCHIVE )
...
CG_CVAR( cg_obituaryOutput, "cg_obituaryOutput", "3", CVAR_ARCHIVE )
...
CG_CVAR( pmove_float, "pmove_float", "1", CVAR_SYSTEMINFO )
...
CG_CVAR( cg_oldRail, "cg_oldRail", "0", CVAR_ARCHIVE )
CG_CVAR( cg_oldRocket, "cg_oldRocket", "1", CVAR_ARCHIVE )
CG_CVAR( cg_leiEnhancement, "cg_leiEnhancement", "0", CVAR_ARCHIVE )             // LEILEI default off (in case of wiener)
CG_CVAR( cg_leiGoreNoise, "cg_leiGoreNoise", "0", CVAR_ARCHIVE )                 // LEILEI
CG_CVAR( cg_leiBrassNoise, "cg_leiBrassNoise", "1", CVAR_ARCHIVE )               // LEILEI
...
CG_CVAR( sv_fps, "sv_fps", "40", CVAR_SYSTEMINFO )
...
//unlagged - client options
CG_CVAR( cg_trueLightning, "cg_trueLightning", "0.9", CVAR_ARCHIVE )
CG_CVAR( cg_music, "cg_music", "", CVAR_ARCHIVE )

CG_CVAR( cg_fragmsgsize, "cg_fragmsgsize", "0.75", CVAR_ARCHIVE )
...
CG_CVAR( cg_ch1, "cg_ch1", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch1size, "cg_ch1size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch2, "cg_ch2", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch2size, "cg_ch2size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch3, "cg_ch3", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch3size, "cg_ch3size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch4, "cg_ch4", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch4size, "cg_ch4size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch5, "cg_ch5", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch5size, "cg_ch5size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch6, "cg_ch6", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch6size, "cg_ch6size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch7, "cg_ch7", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch7size, "cg_ch7size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch8, "cg_ch8", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch8size, "cg_ch8size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch9, "cg_ch9", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch9size, "cg_ch9size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch10, "cg_ch10", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch10size, "cg_ch10size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch11, "cg_ch11", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch11size, "cg_ch11size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch12, "cg_ch12", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch12size, "cg_ch12size", "24", CVAR_ARCHIVE )
CG_CVAR( cg_ch13, "cg_ch13", "1", CVAR_ARCHIVE )
CG_CVAR( cg_ch13size, "cg_ch13size", "24", CVAR_ARCHIVE )
...
CG_CVAR( cg_weaponBarStyle, "cg_weaponBarStyle", "8", CVAR_ARCHIVE )
CG_CVAR( cg_weaponOrder, "cg_weaponOrder", "/1/2/4/3/6/7/8/9/5/", CVAR_ARCHIVE )
CG_CVAR( cg_chatBeep, "cg_chatBeep", "1", CVAR_ARCHIVE )
CG_CVAR( cg_teamChatBeep, "cg_teamChatBeep", "1", CVAR_ARCHIVE )
CG_CVAR( cg_developer, "developer", "0", CVAR_CHEAT )

//OmegA
CG_CVAR( cg_ambient, "cg_ambient", "1", CVAR_ARCHIVE | CVAR_LATCH )
CG_CVAR( cg_bobgun, "cg_bobgun", "1", CVAR_ARCHIVE )
CG_CVAR( cg_brightPlayers, "cg_brightPlayers", "1", CVAR_ARCHIVE )
CG_CVAR( cg_damagePlums, "cg_damagePlums", "1", CVAR_USERINFO | CVAR_ARCHIVE )
CG_CVAR( cg_deadColor, "cg_deadColor", "", CVAR_ARCHIVE )
CG_CVAR( cg_draw3DCrosshairNames, "cg_draw3DCrosshairNames", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawEmotes, "cg_drawEmotes", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawEnemy, "cg_drawEnemy", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawFriendSkulls, "cg_friendSkulls", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawFriendThroughWalls, "cg_friendThroughWalls", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawItemPickup, "cg_drawItemPickup", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawOldScoreboard, "cg_drawOldScoreboard", "0", CVAR_ARCHIVE )
CG_CVAR( cg_drawSmallHealthSphere, "cg_drawSmallHealthSphere", "0", CVAR_ARCHIVE )
CG_CVAR( cg_drawTeamBackground, "cg_drawTeamBackground", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawThirdPersonCrosshair, "cg_drawThirdPersonCrosshair", "1", CVAR_ARCHIVE )
CG_CVAR( cg_enemyColor, "cg_enemyColor", "", CVAR_ARCHIVE )
CG_CVAR( cg_enemyModel, "cg_enemyModel", "", CVAR_ARCHIVE )
CG_CVAR( cg_enemySounds, "cg_enemySounds", "", CVAR_ARCHIVE )
CG_CVAR( cg_flagStyle, "cg_flagStyle", "2", CVAR_ARCHIVE | CVAR_LATCH )
CG_CVAR( cg_forceTeamSkins, "cg_forceTeamSkins", "1", CVAR_ARCHIVE )
CG_CVAR( cg_hitmarker, "cg_hitmarker", "1", CVAR_ARCHIVE )
CG_CVAR( cg_killsound, "cg_killsound", "1", CVAR_ARCHIVE )
CG_CVAR( cg_omegaInitialized, "cg_omegaInitialized", "0", CVAR_ARCHIVE )
CG_CVAR( cg_predictAmmo, "cg_predictAmmo", "1", CVAR_ARCHIVE )
CG_CVAR( cg_screenshake, "cg_screenshake", "1", CVAR_ARCHIVE )
CG_CVAR( cg_selfSounds, "cg_selfSounds", "", CVAR_ARCHIVE )
CG_CVAR( cg_showSpawns, "cg_showSpawns", "1", CVAR_ARCHIVE )
CG_CVAR( cg_shotgunSparks, "cg_shotgunSparks", "1", CVAR_ARCHIVE )
CG_CVAR( cg_showSpecZoom, "cg_showSpecZoom", "1", CVAR_ARCHIVE )
CG_CVAR( cg_smoothBodySink, "cg_smoothBodySink", "1", CVAR_ARCHIVE )
CG_CVAR( cg_switchCycle, "cg_switchCycle", "1", CVAR_ARCHIVE )
CG_CVAR( cg_teamColor, "cg_teamColor", "", CVAR_ARCHIVE )
CG_CVAR( cg_teamModel, "cg_teamModel", "", CVAR_ARCHIVE )
CG_CVAR( cg_teamSounds, "cg_teamSounds", "", CVAR_ARCHIVE )
CG_CVAR( cg_thinLightningBolt, "cg_thinLightningBolt", "0", CVAR_ARCHIVE | CVAR_LATCH )
CG_CVAR( cg_thirdPersonFlagSprite, "cg_thirdPersonFlagSprite", "0", CVAR_ARCHIVE )
CG_CVAR( cg_timerHeight, "cg_timerHeight", "25", CVAR_ARCHIVE )
CG_CVAR( cg_timerWidth, "cg_timerWidth", "25", CVAR_ARCHIVE )
CG_CVAR( cg_timerX, "cg_timerX", "318", CVAR_ARCHIVE )
CG_CVAR( cg_timerY, "cg_timerY", "2", CVAR_ARCHIVE )
CG_CVAR( cg_transparentGun, "cg_transparentGun", "0", CVAR_ARCHIVE )
CG_CVAR( cg_wallhack, "cg_wallhack", "0", CVAR_ARCHIVE | CVAR_CHEAT )
CG_CVAR( cg_zoomAnim, "cg_zoomAnim", "1", CVAR_ARCHIVE )
CG_CVAR( cg_zoomAnimSpeed, "cg_zoomAnimSpeed", "2", CVAR_ARCHIVE )
CG_CVAR( cg_zoomToggle, "cg_zoomToggle", "0", CVAR_ARCHIVE )
CG_CVAR( com_maxfps, "com_maxfps", "250", CVAR_ARCHIVE )
CG_CVAR( pmove_aircontrol, "pmove_aircontrol", "0", CVAR_SYSTEMINFO )
CG_CVAR( pmove_autohop, "pmove_autohop", "0", CVAR_SYSTEMINFO )
CG_CVAR( pmove_doublejump, "pmove_doublejump", "0", CVAR_SYSTEMINFO )
CG_CVAR( pmove_overbounce, "pmove_overbounce", "0", CVAR_SYSTEMINFO )
