...
/*
================
CG_SmallBloodTrail LEILEI
================
*/
static void CG_SmallBloodTrail( localEntity_t *le ) {
	int t;
	int t2;
	int step;
	vec3_t newOrigin;
...
================
*/
static void CG_GoreMark( localEntity_t *le, trace_t *trace ) {
	int radius;
...
================
*/
static void CG_SplatSound( localEntity_t *le, trace_t *trace ) {
	if ( le->leBounceSoundType == LEBS_BLOOD ) {
...
================
*/
static void CG_JustSplat( localEntity_t *le, trace_t *trace ) {
	vec3_t velocity;
	float dot;
	int hitTime;
...
================
*/
static void CG_AddGore( localEntity_t *le ) {
	vec3_t newOrigin;
	trace_t trace;
