...
#define UI_MEDIUMFONT	0x00000020
#define UI_BIGFONT		0x00000040	// default
#define UI_GIANTFONT	0x00000080
...
void NORETURN FORMAT_PRINTF(2, 3) QDECL Com_Error( int level, const char *error, ... );
