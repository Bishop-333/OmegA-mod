...
textures/cosmo_sfx/flag_oa_brown1
{
    ...
    {
        map textures/cosmo_sfx/flag_oa_brown1
        blendFunc GL_ONE GL_ZERO
        alphaFunc GE128
		rgbGen identity
	}
...
{
	qer_editorimage textures/cosmo_sfx/decal2
	nopicmip
    polygonOffset

    {
        map textures/cosmo_sfx/decal2
        blendFunc blend
		rgbGen identity
	}
}
...
{
	qer_editorimage textures/cosmo_sfx/decal3
	nopicmip
    polygonOffset

    {
        map textures/cosmo_sfx/decal3
        blendFunc blend
		rgbGen identity
	}
}
